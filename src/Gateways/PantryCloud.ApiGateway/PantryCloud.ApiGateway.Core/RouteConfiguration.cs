...
{
    public const string IdentityRouteId = "identity-service";
    public const string HouseholdRouteId = "household-service";
    public const string PantryRouteId = "pantry-service";
    ...
    public const string PantryClusterId = "pantry-cluster";
