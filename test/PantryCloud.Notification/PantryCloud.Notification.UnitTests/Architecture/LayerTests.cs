...
{
    private const string InfrastructureNamespace = "PantryCloud.Notification.Infrastructure";
    private const string PresentationNamespace = "PantryCloud.Notification.Presentation";
    private const string ApplicationNamespace = "PantryCloud.Notification.Application";
