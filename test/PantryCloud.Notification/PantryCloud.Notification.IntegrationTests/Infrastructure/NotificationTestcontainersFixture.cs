...
public sealed class NotificationTestcontainersFixture : IAsyncLifetime
{
    ...
    public string NotificationBaseUrl => $"http://{_notificationApi.Hostname}:{_notificationApi.GetMappedPublicPort(Constants.Notification.Port)}";
    public string RabbitMqHostPort => $"{_rabbitMq.Hostname}:{_rabbitMq.GetMappedPublicPort(Constants.RabbitMq.AmqpPort)}";

    public NotificationTestcontainersFixture()
    {
